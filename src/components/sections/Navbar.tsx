    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6 flex items-center justify-between">
          ...
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl overflow-hidden shadow-lg shadow-primary/25 group-hover:scale-110 transition-transform cursor-pointer relative bg-deep-space flex-shrink-0">
              <Image
                src="/sqlogo.jpeg"
                alt="Genoxlab Logo"
                fill
