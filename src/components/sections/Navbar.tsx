...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* Mobile Menu Overlay */}
            <div className={`fixed inset-0 bg-deep-space/95 backdrop-blur-2xl z-[90] transition-all duration-500 overflow-hidden ${mobileMenuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}>
